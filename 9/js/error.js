...
const audio1 = new Audio("https://classic.systemspace.network/res/audio/bgm/something.ogg"); // Replace with actual path for audio 1
const audio2 = new Audio("https://classic.systemspace.network/res/audio/bgm/something.ogg"); // Replace with actual path for audio 2

const ambience = new Audio("https://classic.systemspace.network/res/audio/ambience/5.ogg");
ambience.loop = true;
