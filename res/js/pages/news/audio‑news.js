...
const audio1 = new Audio("https://kikyou.space/res/bgm/news2.ogg"); // Replace with actual path for audio 1
const audio2 = new Audio("https://kikyou.space/res/bgm/news2.ogg"); // Replace with actual path for audio 2
