...
const audio1 = new Audio("https://kikyou.space/res/bgm/info-intro.ogg"); // Replace with actual path for audio 1
const audio2 = new Audio("https://kikyou.space/res/bgm/info-loop.ogg"); // Replace with actual path for audio 2
