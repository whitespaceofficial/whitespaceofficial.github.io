...
const audio1 = new Audio("https://kikyou.space/res/bgm/cmp-intro.ogg"); // Replace with actual path for audio 1
const audio2 = new Audio("https://kikyou.space/res/bgm/cmp-loop.ogg"); // Replace with actual path for audio 2
