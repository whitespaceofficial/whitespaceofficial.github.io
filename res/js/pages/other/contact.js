...
const audio1 = new Audio("https://new.systemspace.network/res/audio/music/contact.ogg"); // Replace with actual path for audio 1
const audio2 = new Audio("https://new.systemspace.network/res/audio/music/contact.ogg"); // Replace with actual path for audio 2
