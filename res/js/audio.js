...
const audio1 = new Audio("https://kikyou.space/res/bgm/home-intro.ogg"); // Replace with actual path for audio 1
const audio2 = new Audio("https://kikyou.space/res/bgm/home-loop.ogg"); // Replace with actual path for audio 2
